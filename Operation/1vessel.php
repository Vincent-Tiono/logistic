        ...
        <div class="d-flex gap-2 align-items-center">
          <div class="position-relative" style="width:320px;">
            <input id="q" type="text" class="form-control form-control-sm" style="width:100%; padding-right:26px;"
                   placeholder="Search (No. Reff / No. SI)..." />
      ...
      <div class="table-responsive">
        <table class="table table-sm table-bordered align-middle" id="tbl">
          <thead class="table-light">
            <tr>
              <th style="min-width:120px;" class="sortable" data-key="no_pk" data-type="text" data-label="No. Reff"></th>
              ...
              <th style="min-width:130px;" class="sortable" data-key="laycan_end" data-type="date" data-label="Laycan End"></th>
              <th style="min-width:120px;" class="sortable" data-key="ta_vessel" data-type="date" data-label="TA Vessel"></th>
              <th style="min-width:120px;" class="sortable" data-key="pkk" data-type="date" data-label="PKK"></th>
...
function columnDisplayValue(r, key){
  if (key === 'ta_vessel' || key === 'pkk' || key === 'rkbm'){
...
tbody.addEventListener('click', async (e)=>{
  ...
  if (e.target.classList.contains('btnDelete')){
    ...
    if (res.ok){
      showAlert('success', res.msg);
      originalData = originalData.filter(r => r.no_pk !== no_pk);
      tr.remove();
